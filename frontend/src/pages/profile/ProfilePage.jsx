  ...
  return (
    <>
      <div className='flex-[4_4_0]  border-r border-gray-700 min-h-screen '>
        ...
        {!isLoading && !isRefetching && !data?.user && <p className='text-center text-lg mt-4'>User not found</p>}
        <div className='flex flex-col'>
          {!isLoading && !isRefetching && data?.user && (
            <>
              ...
              <div className='flex justify-end px-4 mt-5'>
                ...
                {!isMyProfile && (
                  <button
                    ...
                    onClick={() => followMutation(data?.user?._id)}
                  >
                    {isPending && 'Loading...'}
              ...
              <div className='flex flex-col gap-4 mt-14 px-4'>
                <div className='flex flex-col'>
                  ...
                  <span className='text-sm text-slate-500'>@{data?.user.username}</span>
                ...
                <div className='flex gap-2'>
                  <div className='flex gap-1 items-center'>
                    <span className='font-bold text-xs'>{data?.user.following.length}</span>
                    <span className='text-slate-500 text-xs'>Following</span>
                  </div>
                  <div className='flex gap-1 items-center'>
                    <span className='font-bold text-xs'>{data?.user.followers.length}</span>
